...
def insert_expose(expose_index, ports, content):
    """Expose ports after the line "Expose Ports" in the docker file.

    This works by inserting the port to be exposed in the list of the
    Docker file's contents

    Args:
        expose_index: The index of the line "Expose Ports" in the Dockerfile
        ports: The list of ports to be exposed
        content: The content of the Dockerfile
...
def get_expose_index(content):
    """Retrieve the index of the line "Expose Ports" from the Dockerfile.

    Args:
        content: The content of the dockerfile

    Returns:
        expose_index: The index of the line "Expose Ports"
    """
