#!/usr/bin/env python3
"""Script to test all the pattoo-web unittests.
...
def main():
    """Test all the pattoo-web modules with unittests.
...
def run_script(cli_string):
    ...
    pattoo_returncode = ('----- pattoo-web Return Code '
                         '----------------------------------------')
    pattoo_stdoutdata = ('----- pattoo-web Test Output '
                         '----------------------------------------')
    pattoo_stderrdata = ('----- pattoo-web Test Error '
                         '-----------------------------------------')
