...
width="100%">
<thead><tr><th>Target</th><th>DataPoint</th><th>Metadata</th><th>Chart</th>\
</tr></thead>
<tbody>
<tr><td>localhost</td><td></td><td><p>Pattoo Agent: pattoo_agent_snmpd<br>\
None: .1.3.6.1.2.1.2.2.1.16.3</p></td><td><a href="/pattoo/web/chart/datapoint\
    ...
    def test__flask_table_rows(self):
        ...
        expected = [
            {'target': 'localhost',
             'key': None,
             'metadata': '''\
<p>Pattoo Agent: pattoo_agent_snmpd<br>None: .1.3.6.1.2.1.2.2.1.16.3</p>''',
             'link': '''\
