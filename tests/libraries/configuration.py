...
NOTE!! This script CANNOT import any pattoo-web libraries. Doing so risks
...
class UnittestConfig():
    ...
    def __init__(self):
        ...
        config_suffix = '.pattoo-web-unittests{}config'.format(os.sep)
...
'''.format(screen_message, os.environ['PATTOO_CONFIGDIR']))
    ...
    if 'unittest' not in os.environ['PATTOO_CONFIGDIR']:
        ...
        log.log2die_safe(80008, log_message)
